...
[CTF Challenges](#ctf-challenges)
  1. [Talk to Santa](#talk-to-santa)
  2. [Two Turtle Doves](#two-turtle-doves)
  3. [Unredact Threatening Document](#unredact-threatening-document)
  4. [Windows Log Analysis - Attack Outcome](#windows-log-analysis-attack-outcome)
  5. [Windows Log Analysis - Attacker Technique](#windows-log-analysis-attacker-technique)
  6. [Network Log Analysis - Determine Compromised System](#network-log-analysis-determine-compromised-system)
  7. [Splunk](#splunk)
  8. [Access Steam Tunnels](#access-steam-tunnels)
  9. [Bypass Frido Sleigh CAPTEHA](#bypass-frido-sleigh-capteha)
  10. [Retrieve Scraps of Paper from Server](#retrieve-Scraps-of-paper-from-server)
  11. [Recover Cleartext Document](#recover-cleartext-document)
  12. [Open Sleigh Shop Door](#open-sleigh-shop-door)
  13. [Filter Out Poisoned Sources of Weather Data](#filter-out-poisoned-sources-of-weather-data)
